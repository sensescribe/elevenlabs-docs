...
This guide will help you get started with [ElevenLabs](https://elevenlabs.io). We will cover everything, starting with creating an account, and then moving on to cloning your first voice using the [VoiceLab](/voice-lab/overview).
...
The AI models have been trained on a vast amount of audio and are suitable for a wide variety of tasks, ranging from more natural and conversational speech to more dramatic audiobook readings. We offer multiple different [models](/speech-synthesis/models), each one has been trained differently and has its own strengths.
...
We offer five public plans: `Free`, `Starter`, `Creator`, `Pro`, and `Scale`. In addition, we also offer a sixth option - `Enterprise` - tailored to the unique needs and usage of our clients.
